...
public class CymbolParser extends Parser {
    ...
    public static class ParameterListContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CymbolVisitor)
                return ((CymbolVisitor<? extends T>) visitor).visitParameterList(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StmtContext extends ParserRuleContext {
        ...
        public TerminalNode RETURN() {
            return getToken(CymbolParser.RETURN, 0);
        }
    ...
    public static class IfStmtContext extends ParserRuleContext {
        ...
        public TerminalNode IF() {
            return getToken(CymbolParser.IF, 0);
        }
    ...
    public static class CallContext extends StatContext {
        public CallContext(StatContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AsnContext extends StatContext {
        public AsnContext(StatContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotContext extends ExprContext {
        ...
        public TerminalNode NOT() {
            return getToken(CymbolParser.NOT, 0);
        }
    ...
    public static class NumberContext extends ExprContext {
        ...
        public TerminalNode NUMBER() {
            return getToken(CymbolParser.NUMBER, 0);
        }
    ...
    public static class MulDivContext extends ExprContext {
        ...
        public TerminalNode MUL() {
            return getToken(CymbolParser.MUL, 0);
        }

        public TerminalNode DIV() {
            return getToken(CymbolParser.DIV, 0);
        }
    ...
    public static class AddSubContext extends ExprContext {
        ...
        public TerminalNode ADD() {
            return getToken(CymbolParser.ADD, 0);
        }

        public TerminalNode SUB() {
            return getToken(CymbolParser.SUB, 0);
        }
    ...
    public static class GtLtContext extends ExprContext {
        ...
        public GtLtContext(ExprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode GT() {
            return getToken(CymbolParser.GT, 0);
        }

        public TerminalNode LT() {
            return getToken(CymbolParser.LT, 0);
        }
