...
public class SoulParser extends Parser {
	...
	public static class DescribtionContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(SoulParser.ID, 0); }
		...
		@Override public int getRuleIndex() { return RULE_describtion; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class FIELD_RANGEContext extends StmtContext {
		...
		public FIELD_RANGEContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class FIELD_BLOCKContext extends StmtContext {
		...
		public FIELD_BLOCKContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class FIELD_RELYContext extends StmtContext {
		...
		public FIELD_RELYContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class IDSContext extends StmtContext {
		public List<TerminalNode> ID() { return getTokens(SoulParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(SoulParser.ID, i);
		}
		public IDSContext(StmtContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class RangeContext extends ParserRuleContext {
		public List<TerminalNode> NUMBER() { return getTokens(SoulParser.NUMBER); }
