...
public class AbstractMachine {
	...
	private static String[] instructions = {"add","and","asn","call","div","dup","eq","ge",
			"gt","halt","jmp","jz","ldc","ldv","le","lt","mul","neq","not","or","rem","ret","sub"};
	...
	public Object compute() {
		...
		while (currentFrame().isNotEndOfInstructions()) {
			...
			int index = Arrays.binarySearch(instructions, ins.getName());
			switch(index){
